...
<html lang="en"> 
<head>
    <title>Mighty Locator dashboard</title>
...
<body class="ml app">
	...
	<header class="header header_fixed" style="display: none">
		<div class="container container_fullwidth header__container colGr">
			<div class="colGr__col_3">
				<a href="<?php echo home_url(); ?>">Mighty Locator</a>
			</div>
			<div class="colGr__col_6"></div>
			<div class="colGr__col_3 colGr__col_rightAlign">
				<a href="#">Settings</a>
				<a href="#">Profile</a>
			</div>
		</div>
		            ...
		            <div class="app-utilities col-auto">
						...
						<div class="app-utility-item app-user-dropdown dropdown">
				            ...
				            <ul class="dropdown-menu" aria-labelledby="user-dropdown-toggle">
								<li><a class="dropdown-item" href="<?php echo home_url( '/personal-settings' ); ?>">Profile</a></li>
								<li><a class="dropdown-item" href="<?php echo home_url( '/membership' ); ?>">Membership</a></li>
	        ...
	        <div class="sidepanel-inner d-flex flex-column">
			    ...
			    <nav id="app-nav-main" class="app-nav app-nav-main flex-grow-1">
				    <ul class="app-menu list-unstyled accordion" id="menu-accordion">
						<li class="nav-item">
							<a class="nav-link" href="<?php echo home_url( '/profile' ); ?>">
								<span class="nav-icon">
