		        ...
		        <div class="app-header-content"> 
		            ...
		            <div class="app-utilities col-auto">
			            <div class="app-utility-item">
				            <a href="<?php echo home_url( '/settings' ); ?>" title="Settings">
						...
						<div class="app-utility-item app-user-dropdown dropdown">
				            <a class="dropdown-toggle" id="user-dropdown-toggle" data-bs-toggle="dropdown" href="#" role="button" aria-expanded="false">
								<div class="header__avatar">
									<?php if( get_field( 'user_avatar' , 'user_' . get_current_user_id() ) ){ ?>
										<img
											src="<?php the_field( 'user_avatar' , 'user_' . get_current_user_id() ); ?>"
											alt="user profile"
				            ...
				            <ul class="dropdown-menu" aria-labelledby="user-dropdown-toggle">
								<li><a class="dropdown-item" href="<?php echo home_url( '/account' ); ?>">Account</a></li>
								<li><a class="dropdown-item" href="<?php echo home_url( '/pricing' ); ?>">Pricing</a></li>
								<li><a class="dropdown-item" href="<?php echo home_url( '/settings' ) ; ?>">Settings</a></li>
				    ...
				    <ul class="app-menu list-unstyled accordion" id="menu-accordion">
						...
						<li class="nav-item">
							<a class="nav-link" href="<?php echo home_url( '/skips-archive' ); ?>">
								...
								<span class="nav-link-text">Skips Archive</span>
							</a>
						</li>
						<li class="nav-item">
					        <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
					        <a class="nav-link" href="<?php echo home_url( '/billing' ); ?>">
						        <span class="nav-icon">
			...
			<div class="app-sidepanel-footer">
				<nav class="app-nav app-nav-footer">
					<ul class="app-menu footer-menu list-unstyled">
						<li class="nav-item">
							<a class="nav-link" href="<?php echo home_url( '/settings' ); ?>">
								<span class="nav-icon">
